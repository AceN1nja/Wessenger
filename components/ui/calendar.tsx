...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      captionLayout="dropdown-buttons" fromYear={1970} toYear={new Date().getFullYear() - 15}
      classNames={{
        months: "flex flex-col sm:flex-row space-y-4 sm:space-x-4 sm:space-y-0",
        month: "space-y-4",
        caption: "flex justify-center pt-1 relative items-center",
        caption_label: "text-sm hidden",
        caption_dropdowns: "flex px-2 gap-1",
        vhidden: "sr-only",
        dropdown: "rounded border border-stone-200 bg-white dark:border-stone-800 dark:bg-stone-950 p-1",
